...
const CallToAction = () => {
  ...
  return (
    <div className='flex flex-col items-center gap-4 pt-10 pb-24 px-8 md:px-0'>
      ...
      <p className='text-gray-500 sm:text-sm text-center max-w-2xl'>Que vous soyez un étudiant cherchant à améliorer vos compétences ou un éducateur souhaitant partager ses connaissances, LearnHub LMS est la plateforme idéale pour vous.</p>
